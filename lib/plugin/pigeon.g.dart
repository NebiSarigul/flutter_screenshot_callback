...
class ScreenShotCallbackHostApi {
  ...
  Future<void> initialize() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.screenshot_callback_fix.ScreenShotCallbackHostApi.initialize';
  ...
  Future<void> dispose() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.screenshot_callback_fix.ScreenShotCallbackHostApi.dispose';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
...
abstract class ScreenShotCallbackFlutterApi {
  ...
  static void setup(ScreenShotCallbackFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.screenshot_callback_fix.ScreenShotCallbackFlutterApi.screenShotCallback', pigeonChannelCodec,
